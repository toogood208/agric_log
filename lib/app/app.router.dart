...
import 'package:agri_logistics/ui/views/detail_view/detail_view.dart' as _i3;
import 'package:agri_logistics/ui/views/home_view/home_view.dart' as _i2;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i3.DetailView: (data) {
      ...
      return _i1.buildAdaptivePageRoute<dynamic>(
        builder: (context) => _i3.DetailView(key: args.key, title: args.title),
        settings: data,
      );
    },
  };
...
extension NavigatorStateExtension on _i5.NavigationService {
  ...
  Future<dynamic> navigateToDetailView({
    ...
    return navigateTo<dynamic>(Routes.detailView,
        arguments: DetailViewArguments(key: key, title: title),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
